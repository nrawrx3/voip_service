            ...
            Ok(line) => {
                ...
                match command {
                    ...
                    "status" => {
                        ...
                        let room_name = service.current_room.as_deref().unwrap_or("None");
                        println!(
                    ...
                    "login" => {
                        ...
                        if let (Some(user), Some(room)) = (user_name, room_name) {
                            ...
                            service.current_room = Some(room.to_string());
                    ...
                    "connect" => {
                        ...
                        tokio::spawn(async move {
                            ...
                            if service.current_user_name.is_none() || service.current_room.is_none() {
